...
- [Code Coverage example](./code_coverage/README.md)
  - This example demonstrates how to generate code coverage reports for Anchor programs using Surfpool's register-tracing feature and sbpf-coverage.
